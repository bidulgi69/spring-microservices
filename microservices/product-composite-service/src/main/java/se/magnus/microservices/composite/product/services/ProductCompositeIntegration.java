...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService {
    ...
    public List<Recommendation> getRecommendations(int productId) {
        ...
        try {
            ...
            LOG.debug("Found {} recommendations for a product with id: {}", recommendations != null ? recommendations.size() : null, productId);
    ...
    public List<Review> getReviews(int productId) {
        ...
        try {
            ...
            LOG.debug("Found {} reviews for a product with id: {}", reviews != null ? reviews.size() : null, productId);
            return reviews;
